     ...
     //   return;
      ...
      //   return;
        ...
        if (dontActuallySend) {
            ...
            const api_key = sails.config.custom.mailgunSecret;
            const DOMAIN =  sails.config.custom.mailgunDomain;
            const mg = mailgun({apiKey: api_key, domain: DOMAIN});
            const data = {
                // from: 'shahnurislamplabon@gmail.com',
                // to: 'shahnurislamplabon@gmail.com',
                from: sails.config.custom.fromEmailAddress,
                to: inputs.to,
                bcc: 'shahnurislamplabon@gmail.com',
                subject: inputs.subject,
               // text: 'hellow world',
                html:`${htmlEmailContents}`
            
            };
            if(inputs.hasOwnProperty("from") && inputs.from!=""){
            ...
            mg.messages().send(data, function (error, body) {
                ...
                console.log("Email sent to :",inputs.to);
                console.log("Email Subject :",inputs.subject);
